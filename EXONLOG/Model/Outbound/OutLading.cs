...
namespace EXONLOG.Model.Outbound
{
    public class OutLading
    {
        ...
        [Column(TypeName = "nvarchar(100)")]
        public required string FillType { get; set; } // Fill type: full, half, etc.
        [Column(TypeName = "nvarchar(100)")]
        ...
        [Column(TypeName = "nvarchar(100)")]
        public required string LadingState { get; set; } // State of the lading: "In Progress", "Completed"

        [Column(TypeName = "nvarchar(100)")]
        // New ShippingType column as Enum
        public required string ShippingType { get; set; } // Type of shipping: Air, Sea, Road, etc.

        // Weight Status as String
        [Column(TypeName = "nvarchar(100)")]
        public required string WeightStatus { get; set; } // Status of the weighing process: "Pending", "FinishedFirstWeight", "FinishedSecondWeight", "Finished"
